// Topbar fijo (marquee top:0) — barra fina que funciona como botón de registro permanente
// (todo el bloque es <a href="#registro">). Dos filas apiladas con loop horizontal infinito
...
const PHRASES: Record<Lang, string> = {
  es: 'Reserva tu lugar en el webinar gratuito de ATFX',
  en: 'Reserve your spot in the free ATFX webinar',
};
...
function buildRow(modifier: '1' | '2', phrase: string): HTMLElement {
...
export function renderTopbar(root: Element, lang: Lang): void {
  ...
  rows.append(buildRow('1', phrase), buildRow('2', phrase));
